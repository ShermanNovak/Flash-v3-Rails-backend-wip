...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference("Folder.count") do
      post folders_url, params: { folder: { foldername: @folder.foldername, user_id: @folder.user_id } }, as: :json
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { foldername: @folder.foldername, user_id: @folder.user_id } }, as: :json
    assert_response :success
  end
